 ...
 Button{
     ...
     MouseArea{
         ...
         onClicked :  {
             ...
             case 4:{pageLoader.source="LocaMusicPage.qml";pageLoader.visible=true;loaderSonglist.visible=false; break;}
             case 5:{pageLoader.source="LoadPage.qml";pageLoader.visible=true;loaderSonglist.visible=false;break;}
             case 8:{pageLoader.source="LyrEditing.qml";pageLoader.visible=true;loaderSonglist.visible=false;break;}
             case 9:{loaderSonglist.visible=false;break}
